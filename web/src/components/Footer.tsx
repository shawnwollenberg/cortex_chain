  ...
  return (
    <footer className="border-t border-border py-8 mt-auto">
      <div className="mx-auto max-w-6xl px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted">
        <p>Cortex &mdash; Base-native agentic commerce</p>
        <div className="flex gap-6">
          ...
          <a href="/blog/cortex-explained" className="hover:text-text transition-colors">Plain English</a>
          <a href="https://github.com/shawnwollenberg/cortex_chain" className="hover:text-text transition-colors">GitHub</a>
        </div>
      </div>
    </footer>
  );
