...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/onboarding`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/docs/sdk-examples`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
