...
- `CommerceRegistry`
  ...
  - Quote commitments: canonical quote hash, merchant, service, agent, token, facilitator, explicit payment rail, amount, zero-fee protocol terms, expiry, payment nonce, resource hash, terms hash, and optional x402 payload hash.
  - Receipts: quote settlement receipt with payment rail, result/resource hashes, fulfillment hash, and zero-fee monetization fields.
  - Disputes: receipt-linked reason and resolution hashes.
  - Trust signals: verification, risk, compliance, and fulfillment signals for merchants, services, facilitators, and agents.
...
5. Quote commitment, receipt recording, fulfillment recording, trust signal recording, dispute opening, and dispute resolution.
6. API reads for merchants, services, facilitators, quotes, receipts, disputes, trust signals, reputation, analytics, policies, intents, and bids.
